...
DIR_RECORDS_INTERNALS = str(Path(DIR_RECORDS, RECORDS_INTERNALS))
DIR_RECORDS_LEAVES = str(Path(DIR_RECORDS, RECORDS_LEAVES))

DIR_CACHE = str(Path(DIR_GOD, "cache"))
DIR_CACHE_DB = str(Path(DIR_CACHE, "db"))
DIR_CACHE_RECORDS = str(Path(DIR_CACHE, "records"))
DIR_CACHE_RECORDS_INTERNALS = str(Path(DIR_CACHE_RECORDS, RECORDS_INTERNALS))
DIR_CACHE_RECORDS_LEAVES = str(Path(DIR_CACHE_RECORDS, RECORDS_LEAVES))
