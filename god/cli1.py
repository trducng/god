...
class RecordCLI:
    ...
    def update(self, name, files, **kwargs):
        ...
        ids = path_to_record_id([files], config)
        update(
            list(ids.values()),
            sets=[st],
            dels=[],
    ...
    def init(self, name, **kwargs):
        ...
        init(
            name, settings.FILE_INDEX, settings.DIR_CACHE_RECORDS, settings.DIR_RECORDS
        )
    ...
    def add(self, name, **kwargs):
        ...
        add(name, settings.FILE_INDEX, settings.DIR_CACHE_RECORDS, settings.DIR_RECORDS)
